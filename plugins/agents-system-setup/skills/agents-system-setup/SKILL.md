...
5. **Build Gate (SDLC) strictness** — only when Phase 1.7 classified the project as `software-dev`; persist `build_gate_strictness` (`standard | strict | light | skipped`). See [sdlc-build-gate](./references/sdlc-build-gate.md).
